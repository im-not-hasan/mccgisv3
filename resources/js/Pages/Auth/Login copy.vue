<template>
  <div class="min-h-screen flex flex-col md:flex-row bg-mcc-gradient bg-[length:100%_200%] animate-bg-pan text-gray-800">
  <div class="flex w-full  mx-auto md:flex-row flex-col items-center justify-between gap-x-10 md:px-20">
    <!-- Left Section -->
    ...
    <div class="w-full md:w-1/2 flex items-center justify-center py-8 animate-slide-in-top">
      <div class="w-[90%] md:max-w-sm bg-white p-6 rounded-lg shadow-xl border border-gray-200">
        ...
        <p class="text-sm text-center text-gray-500 mt-6">
          <a href="#" class="font-medium text-mccblue hover:underline transition">Create a Page</a> for a college department, teacher, or class.
        </p>
      </div>
      </div>
    </div>
