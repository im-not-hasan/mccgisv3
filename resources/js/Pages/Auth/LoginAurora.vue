<template>
  <AuroraBackground>
    ...
    >
  <div class="flex w-full  mx-auto md:flex-row flex-col items-center justify-between gap-x-1 md:px-20">
    <!-- Left Section -->
...
import AuroraBackground from '@/Components/InspiraUI/AuroraBackgound.vue'
