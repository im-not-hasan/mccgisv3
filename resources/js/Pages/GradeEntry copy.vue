<template>
  <div class="p-6 bg-whitebg">
    ...
    <!-- Table -->
    <div class="overflow-auto border rounded-lg max-h-[535px]">
      <table class="min-w-full border-collapse text-xs">
        <thead>
          <!-- Header Row -->
          <tr>
            <th rowspan="3" class="bg-gray-300 border p-2">No.</th>
            <th rowspan="3" class="bg-gray-300 border p-2">LASTNAME</th>
            <th rowspan="3" class="bg-gray-300 border p-2">FIRSTNAME</th>
            <th rowspan="3" class="bg-gray-300 border p-2">MIDDLENAME</th>
          ...
          <tr>
            <th
              ...
              :key="'q-label-'+n"
              class="bg-blue-100 border p-1 text-center sticky top-0 z-30"
            >
              Q{{ n }}
            </th>
            <th class="bg-gray-200 border p-1 text-center sticky top-0 z-30">TOTAL</th>
            <th class="bg-gray-200 border p-1 text-center sticky top-0 z-30">EQUIV</th>
            <th class="bg-gray-200 border p-1 text-center sticky top-0 z-30">30%</th>
            ...
            <th class="bg-gray-200 border p-1 text-center sticky top-0 z-30">TOTAL</th>
            <th class="bg-gray-200 border p-1 text-center sticky top-0 z-30">EQUIV</th>
            <th class="bg-gray-200 border p-1 text-center sticky top-0 z-30">15%</th>

            <th class="bg-blue-100 border p-1 text-center sticky top-0 z-30">100</th>
            <th class="bg-gray-200 border p-1 text-center sticky top-0 z-30">EQUIV</th>
            <th class="bg-gray-200 border p-1 text-center sticky top-0 z-30">15%</th>

            <th class="bg-blue-100 border p-1 text-center sticky top-0 z-30">PRELIM SCORE</th>
            <th class="bg-blue-100 border p-1 text-center sticky top-0 z-30">MIDTERM SCORE</th>
            <th class="bg-gray-200 border p-1 text-center sticky top-0 z-30">TOTAL</th>
            <th class="bg-gray-200 border p-1 text-center sticky top-0 z-30">EQUIV</th>
            <th class="bg-gray-200 border p-1 text-center sticky top-0 z-30">40%</th>

            <th class="bg-gray-200 border p-1 text-center sticky top-0 z-30">MIDTERM GRADE</th>
            <th class="bg-gray-200 border p-1 text-center sticky top-0 z-30">EQUIVALENT</th>
            <th class="bg-gray-100 border p-1 text-center sticky top-0 z-30">REMARKS</th>
          </tr>
          ...
          <tr>
            ...
            <td
              ...
              :key="'hps-quiz-'+i"
              class="border p-1 bg-blue-100 sticky top-8 z-30"
            >
              <input
                v-model.number="hpsQuizzes[i]"
                type="number"
                min="0"
                class="w-12 border px-1 text-center bg-blue-100"
              />
            </td>

            <!-- Quizzes total, equiv, 30% cells -->
            <td class="border p-1 bg-gray-200 text-center font-semibold sticky top-8 z-30">
              {{ totalQuizHPS.toFixed(0) }}
            </td>
            <td class="border p-1 bg-gray-200 text-center sticky top-8 z-30">100</td>
            <td class="border p-1 bg-gray-200 text-center sticky top-8 z-30">30</td>
            ...
            <td class="border p-1 bg-gray-200 text-center sticky top-8 z-30">100</td>
            <td class="border p-1 bg-gray-200 text-center sticky top-8 z-30">15</td>

            <!-- Performance HPS input -->
            <td class="border p-1 bg-blue-100 text-center sticky top-8 z-30">
              <input
            ...
            <td class="border p-1 bg-blue-100 text-center sticky top-8 z-30">
              <input
                ...
                type="number"
                min="0"
                class="w-12 border px-1 text-center bg-blue-100 sticky top-8 z-30"
              />
            </td>
            <!-- Major Exam total, equiv, 40% cells -->
            <td class="border p-1 bg-gray-200 text-center sticky top-8 z-30">
              {{ totalExamHPS.toFixed(0) }}
            </td>
            <td class="border p-1 bg-gray-200 text-center sticky top-8 z-30">100</td>
            <td class="border p-1 bg-gray-200 text-center sticky top-8 z-30">40</td>

            <!-- Prelim blank columns -->
            <td colspan="2" class="border p-1 bg-gray-200 sticky top-8 z-30"></td>
            <td colspan="1" class="border p-1 bg-gray-100 sticky top-8 z-30"></td>
          </tr>
        </thead>
        ...
        <tbody>
          ...
          <tr v-for="(student, index) in students" :key="student.id">
            ...
            <td class="border p-1">{{ student.lname }}</td>
            <td class="border p-1">{{ student.fname }}</td>
            <td class="border p-1">{{ student.mname }}</td>
            ...
            >
              <input
                ...
                class="w-12 border px-1 text-center"
              />
            </td>
            <!-- Quizzes totals -->
